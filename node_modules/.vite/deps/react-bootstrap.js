...
import {
  ...
  ListGroup_default
} from "./chunk-AFD3GO7L.js";
import {
  require_warning
} from "./chunk-JZUR6BR2.js";
import {
  ...
  useWillUnmount,
  useWindow
} from "./chunk-WLAJRVZI.js";
import {
  NavItem_default,
  NavLink_default,
  Nav_default
} from "./chunk-OWNXOWF4.js";
import {
  NavContext_default,
  TabContext_default,
  useForceUpdate
} from "./chunk-UEDPE7YB.js";
import {
  NavbarContext_default
} from "./chunk-VTRVRMPF.js";
import {
  SelectableContext_default,
  dataAttr,
  makeEventKey,
  qsa
} from "./chunk-N65X2IAR.js";
import {
  AlertHeading_default,
  AlertLink_default,
  Alert_default
} from "./chunk-FWVZC4O6.js";
import {
  CloseButton_default,
  ENTERING,
  EXITING,
...
import {
  ...
  useCallbackRef,
  useEventListener
} from "./chunk-RO7EP2IB.js";
import {
  useIsomorphicEffect_default,
  useMounted,
  usePrevious
} from "./chunk-F7L5ZURL.js";
import {
  require_browser,
...
import {
  ...
  CardTitle_default,
  Card_default
} from "./chunk-3AQNSFIR.js";
import "./chunk-IJEWM76N.js";
import {
  divWithClassName_default
} from "./chunk-ZNXEJ2KP.js";
import {
...
var DropdownItem = React21.forwardRef((_ref, ref) => {
  let {
    eventKey,
    disabled,
    onClick,
  ...
  return (0, import_jsx_runtime20.jsx)(Component2, Object.assign({}, props, {
    ref
  }, dropdownItemProps));
});
...
var DropdownContext2 = React23.createContext({});
...
var DropdownDivider = React24.forwardRef(({
  className,
  bsPrefix,
  as: Component2 = "hr",
  role = "separator",
...
var DropdownHeader = React25.forwardRef(({
  className,
  bsPrefix,
  as: Component2 = "div",
  role = "heading",
...
var DropdownItemText = React27.forwardRef(({
  className,
  bsPrefix,
  as: Component2 = "span",
  ...props
...
var InputGroup = React38.forwardRef(({
  ...
  return (0, import_jsx_runtime36.jsx)(InputGroupContext_default.Provider, {
    value: contextValue,
    children: (0, import_jsx_runtime36.jsx)(Component2, {
      ref,
      ...props,
      className: (0, import_classnames28.default)(className, bsPrefix, size2 && `${bsPrefix}-${size2}`, hasValidation && "has-validation")
    })
  });
});
...
var ModalDialog = React40.forwardRef(({
  ...
  return (0, import_jsx_runtime38.jsx)("div", {
    ...props,
    ref,
    className: (0, import_classnames30.default)(dialogClass, className, size2 && `${bsPrefix}-${size2}`, centered && `${dialogClass}-centered`, scrollable && `${dialogClass}-scrollable`, fullscreen && fullScreenClass),
    children: (0, import_jsx_runtime38.jsx)("div", {
      className: (0, import_classnames30.default)(`${bsPrefix}-content`, contentClassName),
      children
    })
  });
});
...
var ModalHeader = React42.forwardRef(({
  ...
  return (0, import_jsx_runtime40.jsx)(AbstractModalHeader_default, {
    ref,
    ...props,
...
var Modal = React44.forwardRef(({
  ...
  const renderBackdrop = (0, import_react23.useCallback)((backdropProps) => (0, import_jsx_runtime42.jsx)("div", {
    ...backdropProps,
    className: (0, import_classnames34.default)(`${bsPrefix}-backdrop`, backdropClassName, !animation && "show")
  ...
  const renderDialog = (dialogProps) => (0, import_jsx_runtime42.jsx)("div", {
    ...
    className: (0, import_classnames34.default)(className, bsPrefix, animateStaticModal && `${bsPrefix}-static`, !animation && "show"),
...
var NavDropdown = React45.forwardRef(({
  ...
  return (0, import_jsx_runtime44.jsxs)(Dropdown_default2, {
    ref,
    ...props,
    className: (0, import_classnames35.default)(className, navItemPrefix),
    children: [(0, import_jsx_runtime43.jsx)(Dropdown_default2.Toggle, {
      id,
      eventKey: null,
      active,
      disabled,
      ...
      as: NavLink_default,
      children: title
    }), (0, import_jsx_runtime43.jsx)(Dropdown_default2.Menu, {
      role: menuRole,
      renderOnMount: renderMenuOnMount,
      rootCloseEvent,
      variant: menuVariant,
...
var Popover = React50.forwardRef(({
  ...
  return (0, import_jsx_runtime48.jsxs)("div", {
    ...
    className: (0, import_classnames38.default)(className, decoratedBsPrefix, primaryPlacement && `bs-popover-${bsDirection}`),
    ...props,
    children: [(0, import_jsx_runtime47.jsx)("div", {
      className: "popover-arrow",
      ...arrowProps
    }), body ? (0, import_jsx_runtime47.jsx)(PopoverBody_default, {
      children
    }) : children]
  });
});
...
var Tooltip = React51.forwardRef(({
  ...
  return (0, import_jsx_runtime50.jsxs)("div", {
    ...
    role: "tooltip",
    "x-placement": primaryPlacement,
    className: (0, import_classnames39.default)(className, bsPrefix, `bs-tooltip-${bsDirection}`),
    ...props,
  ...
  return (0, import_jsx_runtime51.jsx)(Overlay_default, {
    ...
    children: (overlayProps, {
      ...
      return React52.cloneElement(overlay, {
        ...
        popper: popper2,
        hasDoneInitialMeasure,
        className: (0, import_classnames40.default)(overlay.props.className, !transition && show && "show"),
        style: {
          ...overlay.props.style,
          ...overlayProps.style
        }
...
var OverlayTrigger = ({
  ...
  return (0, import_jsx_runtime54.jsxs)(import_jsx_runtime53.Fragment, {
    children: [typeof children === "function" ? children(triggerProps) : (0, import_react28.cloneElement)(children, triggerProps), (0, import_jsx_runtime52.jsx)(Overlay_default2, {
      ...props,
      show,
      onHide: handleHide,
      flip: flip2,
...
var PageItem = React54.forwardRef(({
  ...
  return (0, import_jsx_runtime55.jsx)("li", {
    ref,
    style,
    className: (0, import_classnames41.default)(className, "page-item", {
      active,
      disabled
    }),
    children: (0, import_jsx_runtime56.jsxs)(Component2, {
      className: (0, import_classnames41.default)("page-link", linkClassName),
      style: linkStyle,
      ...props,
...
var Pagination = React55.forwardRef(({
  ...
  return (0, import_jsx_runtime57.jsx)("ul", {
    ref,
    ...props,
    className: (0, import_classnames42.default)(className, decoratedBsPrefix, size2 && `${decoratedBsPrefix}-${size2}`)
  });
});
...
function usePlaceholder({
  ...
  return {
    ...colProps,
    className: (0, import_classnames43.default)(className, animation ? `${bsPrefix}-${animation}` : bsPrefix, size2 && `${bsPrefix}-${size2}`, bg && `bg-${bg}`)
  };
}
...
function renderProgressBar({
  ...
  return (0, import_jsx_runtime60.jsx)("div", {
    ...
    ...props,
    role: "progressbar",
    className: (0, import_classnames44.default)(className, `${bsPrefix}-bar`, {
      [`bg-${variant}`]: variant,
...
var Ratio = React59.forwardRef(({
  ...
  return (0, import_jsx_runtime61.jsx)("div", {
    ...
    className: (0, import_classnames45.default)(bsPrefix, className, !isCustomRatio && `${bsPrefix}-${aspectRatio}`),
...
var Spinner = React61.forwardRef(({
  ...
  return (0, import_jsx_runtime63.jsx)(Component2, {
    ref,
    ...props,
    className: (0, import_classnames47.default)(className, bsSpinnerPrefix, size2 && `${bsSpinnerPrefix}-${size2}`, variant && `text-${variant}`)
  });
});
...
var SplitButton = React62.forwardRef(({
  ...
  flip: flip2,
  ...props
}, ref) => (0, import_jsx_runtime65.jsxs)(Dropdown_default2, {
  ref,
  ...props,
  as: ButtonGroup_default,
  children: [(0, import_jsx_runtime64.jsx)(Button_default2, {
    size: size2,
    variant,
    ...
    type,
    children: title
  }), (0, import_jsx_runtime64.jsx)(Dropdown_default2.Toggle, {
    split: true,
    id,
    size: size2,
    variant,
  ...
  }), (0, import_jsx_runtime64.jsx)(Dropdown_default2.Menu, {
    role: menuRole,
    renderOnMount: renderMenuOnMount,
    rootCloseEvent,
    flip: flip2,
...
var TabPanel = React64.forwardRef(
  ...
  (_ref2, ref) => {
    ...
    return (0, import_jsx_runtime67.jsx)(TabContext_default.Provider, {
      value: null,
      children: (0, import_jsx_runtime67.jsx)(SelectableContext_default.Provider, {
        value: null,
        children: (0, import_jsx_runtime67.jsx)(Transition, {
          in: isActive,
          onEnter,
          onEntering,
          onEntered,
          ...
          mountOnEnter,
          unmountOnExit,
          children: (0, import_jsx_runtime67.jsx)(Component2, Object.assign({}, tabPanelProps, {
            ref,
            hidden: !isActive,
...
var TabContainer = ({
  transition,
  ...props
}) => (0, import_jsx_runtime69.jsx)(Tabs_default, {
  ...props,
...
var TabPane = React68.forwardRef(({
  ...
  return (0, import_jsx_runtime71.jsx)(TabContext_default.Provider, {
    ...
    children: (0, import_jsx_runtime71.jsx)(SelectableContext_default.Provider, {
      value: null,
      children: (0, import_jsx_runtime71.jsx)(Transition, {
        in: isActive,
        onEnter,
        onEntering,
        onEntered,
...
var Table = React69.forwardRef(({
  ...
  const classes = (0, import_classnames51.default)(className, decoratedBsPrefix, variant && `${decoratedBsPrefix}-${variant}`, size2 && `${decoratedBsPrefix}-${size2}`, striped && `${decoratedBsPrefix}-${typeof striped === "string" ? `striped-${striped}` : "striped"}`, bordered && `${decoratedBsPrefix}-bordered`, borderless && `${decoratedBsPrefix}-borderless`, hover && `${decoratedBsPrefix}-hover`);
  const table = (0, import_jsx_runtime72.jsx)("table", {
    ...props,
    className: classes,
    ref
  });
...
function renderTab(child) {
  ...
  return (0, import_jsx_runtime73.jsx)(NavItem_default, {
    as: "li",
    role: "presentation",
    children: (0, import_jsx_runtime73.jsx)(NavLink_default, {
      as: "button",
      type: "button",
      eventKey,
      disabled,
...
var Tabs2 = (props) => {
  ...
  return (0, import_jsx_runtime74.jsxs)(Tabs_default, {
    id,
    activeKey,
    onSelect,
    transition: getTabTransitionComponent(transition),
    mountOnEnter,
    unmountOnExit,
    children: [(0, import_jsx_runtime73.jsx)(Nav_default, {
      id,
      ...controlledProps,
      role: "tablist",
      as: "ul",
    ...
    }), (0, import_jsx_runtime73.jsx)(TabContent_default, {
      children: map(children, (child) => {
        ...
        return (0, import_jsx_runtime73.jsx)(TabPane_default, {
          ...childProps
        });
      })
    })]
...
var ToastFade = React71.forwardRef((props, ref) => (0, import_jsx_runtime75.jsx)(Fade_default, {
  ...props,
  ref,
...
var ToastContext = React72.createContext({
...
var ToastHeader = React73.forwardRef(({
  bsPrefix,
  closeLabel = "Close",
  closeVariant,
  closeButton = true,
  ...
  return (0, import_jsx_runtime77.jsxs)("div", {
    ...
    children: [children, closeButton && (0, import_jsx_runtime76.jsx)(CloseButton_default, {
...
var ToastBody = React74.forwardRef(({
  className,
  bsPrefix,
  as: Component2 = "div",
  ...props
...
var Toast = React75.forwardRef(({
  ...
  const toast = (0, import_jsx_runtime79.jsx)("div", {
    ...props,
    ref,
    className: (0, import_classnames54.default)(bsPrefix, className, bg && `bg-${bg}`, !hasAnimation && (show ? "show" : "hide")),
    role: "alert",
    "aria-live": "assertive",
    "aria-atomic": "true"
  });
  return (0, import_jsx_runtime79.jsx)(ToastContext_default.Provider, {
    value: toastContext,
    children: hasAnimation && Transition ? (0, import_jsx_runtime79.jsx)(Transition, {
      in: show,
      onEnter,
      onEntering,
      onEntered,
...
var ToastContainer = React76.forwardRef(({
  bsPrefix,
  position,
  containerPosition,
  className,
  ...
  return (0, import_jsx_runtime80.jsx)(Component2, {
    ref,
    ...props,
    className: (0, import_classnames55.default)(bsPrefix, position && positionClasses[position], containerPosition && `position-${containerPosition}`, className)
  });
});
...
var noop5 = () => void 0;
var ToggleButton = React77.forwardRef(({
  bsPrefix,
  name,
  className,
  checked,
  ...
  return (0, import_jsx_runtime83.jsxs)(import_jsx_runtime82.Fragment, {
    children: [(0, import_jsx_runtime81.jsx)("input", {
      ...
      id
    }), (0, import_jsx_runtime81.jsx)(Button_default2, {
      ...props,
      ref,
      className: (0, import_classnames56.default)(className, disabled && "disabled"),
      type: void 0,
      role: void 0,
      as: "label",
      htmlFor: id
...
var ToggleButtonGroup = React78.forwardRef((props, ref) => {
  const {
    children,
    type = "radio",
    name,
  ...
  return (0, import_jsx_runtime84.jsx)(ButtonGroup_default, {
    ...controlledProps,
    ref,
    vertical,
    children: map(children, (child) => {
